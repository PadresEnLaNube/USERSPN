...
class USERSPN_Functions_User
{
  ...
  public function userspn_profile_fields($user)
  {
            ...
            <tr>
              <th>
                <?php if (array_key_exists('label', $profile_field)): ?>
                  <label
                    for="<?php echo esc_attr($profile_field['id']); ?>"><?php echo esc_html($profile_field['label']); ?></label>
                <?php endif ?>
              </th>
              <td>
    ...
    if (get_option('userspn_auto_login') == 'on' && current_user_can('administrator')) {
      ...
      <p>
        <?php esc_html_e('This option will allow you to login the platform as the current user profile. This won´t work for administrator profiles, but any other contact all across the website.', 'userspn'); ?>
        <?php esc_html_e('As you login with a new account, you will lose access to yours, so it´s better if you open this link in a private window or other browser.', 'userspn'); ?>
      </p>
      <div class="userspn-text-align-center">
        <a class="userspn-btn userspn-btn-mini" target="_blank"
          href="<?php echo esc_url(self::userspn_link_magic($user_id, home_url())); ?>"><?php esc_html_e('Login as', 'userspn'); ?>
          <?php echo esc_html(self::userspn_user_get_name($user_id)); ?></a>
      </div>
      <?php
    }
  }
  ...
  public function userspn_user_register_fields($atts)
  {
    ...
    ob_start();
    ?>
    <div class="userspn-user-register-fields-wrapper" data-userspn-form-type="<?php echo esc_attr($userspn_form_type); ?>"
      data-userspn-meta="<?php echo esc_attr($userspn_meta); ?>">
      <div
        class="userspn-display-inline-table <?php echo ($userspn_form_type == 'option') ? 'userspn-width-100-percent' : 'userspn-width-50-percent'; ?>  userspn-tablet-display-block userspn-tablet-width-100-percent">
        ...
        <div class="userspn-text-align-right">
          <div class="userspn-display-table userspn-width-100-percent">
            <div
              class="userspn-display-inline-table userspn-width-50-percent userspn-tablet-display-block userspn-tablet-width-100-percent userspn-text-align-center">
              <a href="#" class="userspn-popup"
                data-userspn-popup-id="userspn-user-register-fields-viewer"><?php esc_html_e('Current form', 'userspn'); ?></a>
            </div>
            <div
              class="userspn-display-inline-table userspn-width-50-percent userspn-tablet-display-block userspn-tablet-width-100-percent userspn-text-align-center">
              <a href="#" class="userspn-btn userspn-input-editor-builder-btn-add userspn-pl-50 userspn-pr-50"
                data-userspn-meta="<?php echo esc_attr($userspn_meta); ?>"><?php esc_html_e('Add new field', 'userspn'); ?></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="userspn-user-register-fields-viewer" class="userspn-user-register-fields userspn-display-none-soft">
        <?php if (!empty($userspn_user_register_fields)): ?>
          ...
          <?php endforeach ?>
        <?php else: ?>
          <p class="userspn-user-register-fields-empty">
            <?php esc_html_e('You have not registered any field yet', 'userspn'); ?>
          </p>
        <?php endif ?>
      </div>
    </div>
            ...
            <div class="userspn-profile-wrapper" data-user-id="<?php echo esc_attr($user_id); ?>">
              <div class="userspn-tabs-wrapper">
                <div class="userspn-tabs">
                  <div class="userspn-tab-links active" data-userspn-id="userspn-tab-edit">
                    <?php esc_html_e('Profile', 'userspn'); ?>
                  </div>

                  <?php if (get_option('userspn_user_image') == 'on'): ?>
                    <div class="userspn-tab-links" data-userspn-id="userspn-tab-image"><?php esc_html_e('Image', 'userspn'); ?>
                    </div>
                  <?php endif ?>

                  <?php if (get_option('userspn_user_notifications') == 'on'): ?>
                    <?php if (current_user_can('administrator') || class_exists('MAILPN')): ?>
                      <div class="userspn-tab-links" data-userspn-id="userspn-tab-notifications">
                        <?php esc_html_e('Notifications', 'userspn'); ?>
                      </div>
                    <?php endif ?>
                  <?php endif ?>

                  <?php if ($functions_attachment->userspn_user_files_allowed($user_id)): ?>
                    <div class="userspn-tab-links" data-userspn-id="userspn-tab-files"><?php esc_html_e('Files', 'userspn'); ?>
                    </div>
                  <?php endif ?>
                  ...
                  <?php elseif (current_user_can('administrator')): ?>
                    <div id="userspn-tab-notifications" class="userspn-tab-content userspn-display-none">
                      <div class="userspn-mt-30 userspn-p-10">
                        <p class="userspn-alert">
                          <?php esc_html_e('Notifications are inactive. Please install and activate Mailing Manager - PN to allow integrated notifications in your platform.', 'userspn'); ?>
                        </p>
                        <a href="/wp-admin/plugin-install.php?s=mailpn&tab=search&type=term"
                          class="userspn-btn userspn-btn-mini"><?php esc_html_e('Mailing Manager - PN', 'userspn'); ?></a>
                      </div>
                    </div>
                  <?php endif ?>
                <?php endif ?>
                    ...
                    <div class="userspn-display-table userspn-width-100-percent userspn-mt-30 userspn-mb-30 userspn-p-10">
                        ...
                        <div class="userspn-toggle-wrapper userspn-position-relative userspn-mb-10">
                          <a href="#" class="userspn-toggle userspn-width-100-percent userspn-text-decoration-none">
                            <div class="userspn-display-table userspn-width-100-percent">
                              ...
                              <div
                                class="userspn-display-inline-table userspn-width-10-percent userspn-vertical-align-middle userspn-text-align-right">
                                <i
                                  class="material-icons-outlined userspn-cursor-pointer userspn-vertical-align-middle userspn-color-main-0">add</i>
                              </div>
                            </div>
                          </a>
                      ...
                      <div class="userspn-display-inline-table userspn-width-100-percent userspn-text-align-right">
                        <a href="<?php echo esc_url(wp_logout_url(get_permalink())); ?>"
                          class="userspn-btn userspn-btn-transparent userspn-btn-mini"><?php esc_html_e('Log out', 'userspn'); ?></a>
                      </div>
                    </div>
                            ...
                            <div class="userspn-toggle-wrapper userspn-position-relative userspn-mb-10">
                              <a href="#" class="userspn-toggle userspn-width-100-percent userspn-text-decoration-none">
                                <div class="userspn-display-table userspn-width-100-percent">
                                  <div class="userspn-display-inline-table userspn-width-80-percent userspn-vertical-align-middle">
                                    <label
                                      class="userspn-display-block"><?php esc_html_e('Disconnect account', 'userspn'); ?></label>
                                  </div>
        ...
        <?php else: ?>
          <?php if (!$is_inline): ?>
            <?php if (get_option('userspn_image_custom') == 'on'): ?>
              ...
              <?php if (!empty($custom_ids)): ?>
                ...
                <a href="#"
                  class="userspn-profile-popup-btn userspn-tooltip-left<?php echo (get_option('userspn_disabled') == 'on') ? ' userspn-display-none-soft' : ''; ?>"
                  title="<?php esc_html_e('Your profile', 'userspn'); ?>"><?php echo wp_get_attachment_image($custom_ids[array_rand($custom_ids)], [50, 50], false, ['class' => 'userspn-border-radius-50-percent userspn-m-10 userspn-display-block']); ?></a>
              <?php else: ?>
                <a href="#"
                  class="userspn-profile-popup-btn userspn-tooltip-left<?php echo (get_option('userspn_disabled') == 'on') ? ' userspn-display-none-soft' : ''; ?>"
                  title="<?php esc_html_e('Your profile', 'userspn'); ?>"><i
                    class="material-icons-outlined userspn-profile-icon userspn-color-main-0 userspn-vertical-align-middle userspn-font-size-50">account_circle</i></a>
              <?php endif ?>
            <?php else: ?>
              <a href="#"
                class="userspn-profile-popup-btn userspn-tooltip-left<?php echo (get_option('userspn_disabled') == 'on') ? ' userspn-display-none-soft' : ''; ?>"
                aria-label="<?php esc_html_e('Your profile link button', 'userspn'); ?>"
                title="<?php esc_html_e('Your profile', 'userspn'); ?>"><i
                  class="material-icons-outlined userspn-profile-icon userspn-color-main-0 userspn-vertical-align-middle userspn-font-size-50">account_circle</i></a>
            <?php endif ?>
          <?php endif ?>
          ...
          <?php if ($is_inline): ?>
            <div class="userspn-profile-wrapper">
              <div class="userspn-tabs-wrapper">
                <div class="userspn-tabs">
                  <div class="userspn-tab-links active" data-userspn-id="userspn-tab-login">
                    <?php esc_html_e('Login', 'userspn'); ?>
                  </div>

                  <?php if (get_option('userspn_user_register') == 'on'): ?>
                    <div class="userspn-tab-links" data-userspn-id="userspn-tab-register">
                      <?php esc_html_e('Register', 'userspn'); ?>
                    </div>
                  <?php endif ?>
                </div>
    ...
    <?php if ($total_fields > 0 && get_option('userspn_profile_completion') == 'on' && $completion_percentage < 100): ?>
      <div class="userspn-profile-completion userspn-mt-20 userspn-mb-30">
        ...
        <div class="userspn-profile-completion-bar">
          <div class="userspn-profile-completion-progress" style="width: <?php echo esc_attr($completion_percentage); ?>%">
          </div>
        </div>
        ...
        <div class="userspn-toggle-wrapper userspn-position-relative userspn-mt-10">
          <a href="#" class="userspn-toggle userspn-width-100-percent userspn-text-decoration-none">
            <div class="userspn-display-table userspn-width-100-percent">
              ...
              <div
                class="userspn-display-inline-table userspn-width-20-percent userspn-vertical-align-middle userspn-text-align-right">
            ...
            <div class="userspn-profile-completion-details userspn-mt-10">
              <ul class="userspn-profile-completion-fields-list">
                <?php foreach ($all_fields as $field): ?>
                  <li
                    class="userspn-profile-completion-field-item userspn-list-style-none <?php echo $field['is_completed'] ? 'completed' : 'incomplete'; ?>">
                    <div class="userspn-display-table userspn-width-100-percent">
    ...
    <form id="userspn-profile-edit" class="userspn-mt-30 userspn-form">
      ...
      <?php if (!empty($userspn_base_fields) || !empty($userspn_fields)): ?>
        <div class="userspn-text-align-right userspn-mt-30 userspn-mb-50">
          <input type="submit" value="<?php esc_html_e('Update profile', 'userspn'); ?>" name="userspn-profile-edit-btn"
            id="userspn-profile-edit-btn" class="userspn-btn" data-userspn-type="user"
            data-userspn-user-id="<?php echo esc_attr($user_id); ?>"
            data-userspn-post-id="<?php echo esc_attr($post_id); ?>" /><?php echo esc_html(USERSPN_Data::userspn_loader()); ?>
        </div>
      <?php else: ?>
    ...
    <form action="" method="post">
      <div class="userspn-mt-30 userspn-p-10">
        ...
        <div class="userspn-width-100-percent userspn-text-align-right userspn-mt-30 userspn-mb-30">
          ...
          <input type="submit" name="userspn-upload-files-btn" value="<?php esc_html_e('Upload avatar', 'userspn'); ?>"
            class="userspn-upload-files-btn userspn-btn"
            data-userspn-user-id="<?php echo esc_attr(get_current_user_id()); ?>"><?php echo esc_html(USERSPN_Data::userspn_loader()); ?>
        </div>
      </div>
    </form>
    <?php
  ...
  public function userspn_get_avatar($atts)
  {
    ...
    ?>
    <div
      class="userspn-avatar <?php echo (!empty($user_image) && !empty(wp_get_attachment_image_src($user_image, 'full')[0])) || self::userspn_validate_gravatar($user_id) ? 'userspn-avatar-image' : 'userspn-avatar-empty'; ?> userspn-position-relative userspn-display-inline-block userspn-vertical-align-middle userspn-tooltip"
      data-tooltip-content="#userspn-avatar-<?php echo esc_attr($random); ?>">
      ...
      <?php if ((!empty($user_image) && !empty(wp_get_attachment_image_src($user_image, 'thumbnail')[0]))): ?>
        <img alt="<?php esc_html_e('Profile picture', 'userspn'); ?>"
          description="<?php esc_html_e('Profile picture of', 'userspn'); ?> <?php echo esc_attr(self::userspn_user_get_name($user_id)); ?>"
          src="<?php echo esc_url(wp_get_attachment_image_src($user_image, 'thumbnail')[0]); ?>"
          class="avatar avatar-<?php echo esc_attr($size); ?> photo userspn-border-radius-50-percent userspn-m-10"
      ...
      <?php elseif (self::userspn_validate_gravatar($user_id)): ?>
        ...
        <?php else: ?>
          <div
            class="userspn-avatar-blank userspn-m-10 userspn-text-align-center userspn-display-inline-block userspn-vertical-align-middle"
            style="background-color:<?php echo esc_attr(self::userspn_get_color_random($avatar_params['user_identity'])); ?>;">
            <span
              class="userspn-avatar-first-char userspn-color-white userspn-font-size-25 userspn-line-height-50 userspn-text-transform-uppercase userspn-vertical-align-top"><?php echo esc_html($avatar_params['user_identity'][0]); ?></span>
          </div>
        <?php endif ?>
      <?php else: ?>
        <div
  ...
  public function userspn_user_remove_form()
  {
    ...
    <div class="userspn-display-table userspn-width-100-percent userspn-mt-30 userspn-mb-30 userspn-p-10">
      ...
      <div class="userspn-display-inline-table userspn-width-100-percent userspn-text-align-right">
        <a href="#" class="userspn-popup-open userspn-btn userspn-btn-transparent userspn-btn-mini"
          data-userspn-popup-id="userspn-user-remove-popup"><?php esc_html_e('Remove user', 'userspn'); ?></a>
      </div>
      ...
      <div id="userspn-user-remove-popup" class="userspn-popup userspn-display-none-soft">
        <div class="userspn-popup-content">
          <div class="userspn-p-30">
            ...
            <h2 class="userspn-mt-10 userspn-mb-10 userspn-text-align-center">
              <?php esc_html_e('Account deletion!', 'userspn'); ?>
            </h2>
            <p class="userspn-alert userspn-mb-30">
              <?php esc_html_e('Your account removal will be permanent. This action cannot be undone!', 'userspn'); ?>
            </p>

            <label class="userspn-display-block userspn-toggle" for="userspn_password">
              <?php esc_html_e('Include your password to confirm deletion', 'userspn'); ?>
              <i class="material-icons-outlined userspn-cursor-pointer userspn-float-right">clear</i>
            </label>

            <div class="userspn-toggle-content userspn-display-none-soft" style="display: block;">
              <small><?php esc_html_e('Only letters, numbers and these symbols: !@#$%^&*()_+-=[]{}|;:,.<>?', 'userspn'); ?></small>
            </div>


            <input type="password" name="userspn_password" id="userspn_password"
              class="userspn-input userspn-width-100-percent" placeholder="<?php esc_html_e('Password', 'userspn'); ?>">

            <div class="userspn-width-100-percent userspn-text-align-right">
              <a href="#" class="userspn-btn userspn-user-remove-btn"
                data-userspn-user-id="<?php echo esc_attr(get_current_user_id()); ?>"><?php esc_html_e('Remove user', 'userspn'); ?></a><?php echo esc_html(USERSPN_Data::userspn_loader()); ?>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="userspn-display-table userspn-width-100-percent userspn-mt-30 userspn-mb-30 userspn-p-10">
      ...
      <div class="userspn-display-inline-table userspn-width-100-percent userspn-text-align-right">
        <a href="<?php echo esc_url(wp_lostpassword_url(home_url())); ?>"
          class="userspn-btn userspn-btn-transparent userspn-btn-mini"><?php esc_html_e('Change password', 'userspn'); ?></a>
      </div>
    </div>
    <?php
    $userspn_return_string = ob_get_contents();
    ...
    foreach ($userspn_user_register_fields as $userspn_user_register_field) {
      ...
      if ($field_value !== null) {
        ...
        if ($is_select_multiple && is_array($field_value)) {
          $filtered_value = array_filter($field_value, function ($v) {
            return $v !== '' && $v !== null;
          });
        ...
        if ($is_select_multiple && is_array($field_value)) {
          ...
          $sanitized_value = array_filter($sanitized_value, function ($v) {
            return $v !== '' && $v !== null;
          });
  ...
  public function userspn_csv_template($file_name, $header, $body_rows)
  {
    ...
    ob_start();
    ?>
    <a href="<?php echo esc_url($path['url'] . '/' . $file_name . '.csv'); ?>"
      class="userspn-csv-template-btn userspn-btn userspn-btn-transparent userspn-btn-mini"><?php esc_html_e('Download CSV template', 'userspn'); ?></a>
    <?php
    $userspn_return_string = ob_get_contents();
    ob_end_clean();
    return $userspn_return_string;
  ...
  public function userspn_csv_template_upload()
  {
    ...
    <div class="userspn-p-10">
      ...
      <form action="" method="post">
        ...
        <input type="file" id="userspn-csv-template-file-upload"
          class="userspn-display-block userspn-csv-template-upload-form"
          value="<?php esc_html_e('Upload', 'userspn'); ?>" />

        <div class="userspn-text-align-center userspn-mt-30">
          <input type="submit" name="<?php esc_html_e('Upload', 'userspn'); ?>"
            class="userspn-csv-template-upload-btn userspn-btn userspn-btn-transparent userspn-btn-mini" />
        </div>
      </form>
    </div>
    ...
    if (!empty($array)) {
      ...
      <div class="userspn-text-align-center userspn-mt-30 userspn-mb-50">
        ...
        <div class="userspn-display-table userspn-width-100-percent">
          ...
          <div
            class="userspn-display-inline-table userspn-width-50-percent userspn-tablet-display-block userspn-tablet-width-100-percent userspn-text-align-center">
            <a href="#" class="userspn-btn userspn-csv-add-contacts"><?php esc_html_e('Add contacts', 'userspn'); ?></a><img
              class="userspn-waiting userspn-display-none-soft"
              src="<?php echo esc_url(plugin_dir_url(__FILE__) . 'assets/ajax-loader.gif'); ?>"
              alt="<?php esc_html_e('Loading...', 'userspn'); ?>" />
          </div>
        </div>
      </div>
